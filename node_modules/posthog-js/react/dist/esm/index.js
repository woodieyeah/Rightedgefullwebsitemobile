...
function useFeatureFlagPayload(flag) {
    ...
    var _c = useState(function () { var _a; return (_a = client.getFeatureFlagResult(flag, { send_event: false })) === null || _a === void 0 ? void 0 : _a.payload; }), featureFlagPayload = _c[0], setFeatureFlagPayload = _c[1];
    useEffect(function () {
        return client.onFeatureFlags(function () {
            var _a;
