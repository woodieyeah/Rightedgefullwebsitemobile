...
var parseFlagsResponse = function (response, persistence, currentFlags, currentFlagPayloads, currentFlagDetails, options) {
    var _a, _b, _c, _d;
...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype._getValidFlagKeys = function () {
        var flagKeys = this._config.flag_keys;
        if ((0, core_1.isUndefined)(flagKeys)) {
            return undefined;
        }
        if (!(0, core_1.isArray)(flagKeys)) {
    ...
    PostHogFeatureFlags.prototype._callFlagsEndpoint = function (options) {
        ...
        var queryParams = this._config.advanced_only_evaluate_survey_feature_flags
            ...
            : '';
        var isPartialFlagsResponse = !!this._config.advanced_only_evaluate_survey_feature_flags;
    ...
    PostHogFeatureFlags.prototype.receivedFeatureFlags = function (response, errorsLoading, options) {
        ...
        (0, exports.parseFlagsResponse)(response, this._persistence, currentFlags, currentFlagPayloads, currentFlagDetails, options);
    ...
    PostHogFeatureFlags.prototype.overrideFeatureFlags = function (overrideOptions) {
        ...
        if (overrideOptions === false) {
            this._persistence.unregister(constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAGS);
            this._persistence.unregister(constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAG_PAYLOADS);
        ...
        if ((0, core_1.isArray)(overrideOptions)) {
            ...
            this._persistence.register((_a = {}, _a[constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = flagsObj, _a));
            this._fireFeatureFlagsCallbacks();
            ...
            if ('flags' in options) {
                if (options.flags === false) {
                    ...
                    if ((0, core_1.isArray)(options.flags)) {
                        ...
                        this._persistence.register((_b = {}, _b[constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = flagsObj, _b));
                    }
                    else {
                        this._persistence.register((_c = {}, _c[constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = options.flags, _c));
                    }
            ...
            if ('payloads' in options) {
                if (options.payloads === false) {
                    ...
                    this._persistence.register((_d = {},
                        _d[constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAG_PAYLOADS] = options.payloads,
                        _d));
        ...
        if (overrideOptions && typeof overrideOptions === 'object') {
            this._persistence.register((_e = {},
                _e[constants_1.PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = overrideOptions,
                _e));
            this._fireFeatureFlagsCallbacks();
            return forceDebugLogger.info('Flag overrides set', { flags: overrideOptions });
        }
