...
var ProductTourEventReceiver = /** @class */ (function (_super) {
    ...
    ProductTourEventReceiver.prototype._getShownEventName = function () {
        return posthog_product_tours_types_1.ProductTourEventName.SHOWN;
    };
    ...
    ProductTourEventReceiver.prototype._setActivatedItems = function (eligibleItems) {
        var _a;
        var _b, _c;
        (_c = (_b = this._instance) === null || _b === void 0 ? void 0 : _b.persistence) === null || _c === void 0 ? void 0 : _c.register((_a = {}, _a[constants_1.PRODUCT_TOURS_ACTIVATED] = eligibleItems, _a));
    };
