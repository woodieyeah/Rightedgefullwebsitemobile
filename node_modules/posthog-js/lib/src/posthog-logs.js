...
var PostHogLogs = /** @class */ (function () {
    ...
    PostHogLogs.prototype.captureLog = function (options) {
        ...
        var record = (0, core_1.buildOtlpLogRecord)(options, sdkContext);
    ...
    PostHogLogs.prototype.flushLogs = function (transport) {
        ...
        var payload = (0, core_1.buildOtlpLogsPayload)(entries.map(function (e) { return e.record; }), resourceAttributes, config_1.default.LIB_NAME, config_1.default.LIB_VERSION);
