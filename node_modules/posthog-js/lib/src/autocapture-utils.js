...
function checkIfElementsMatchCSSSelector(elements, selectorList) {
    ...
    var _loop_2 = function (el) {
        if (selectorList.some(function (selector) { return el.matches(selector); })) {
            return { value: true };
        }
    };
    try {
...
function shouldIgnoreByContent(contentIgnorelist, elementsWithText) {
    ...
    return elementsWithText.some(function (_a) {
        ...
        return keywords.some(function (keyword) { return safeText.includes(keyword) || ariaLabel.includes(keyword); });
    });
}
...
function shouldCaptureDomEvent(el, event, autocaptureConfig, captureOnAnyElement, allowedEventTypes) {
    ...
    var _a = getElementAndParentsForElement(el, captureOnAnyElement), parentIsUsefulElement = _a.parentIsUsefulElement, targetElementList = _a.targetElementList;
