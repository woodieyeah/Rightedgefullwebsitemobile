...
var TracingHeaders = /** @class */ (function () {
    function TracingHeaders(_instance) {
        ...
        this._startCapturing = function () {
            var _a, _b, _c, _d;
            var hostnames = _this._getConfiguredHostnames() || [];
            if ((0, core_1.isUndefined)(_this._restoreXHRPatch)) {
                (_b = (_a = globals_1.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.tracingHeadersPatchFns) === null || _b === void 0 ? void 0 : _b._patchXHR(hostnames, _this._instance.get_distinct_id(), _this._instance.sessionManager);
            }
            if ((0, core_1.isUndefined)(_this._restoreFetchPatch)) {
                (_d = (_c = globals_1.assignableWindow.__PosthogExtensions__) === null || _c === void 0 ? void 0 : _c.tracingHeadersPatchFns) === null || _d === void 0 ? void 0 : _d._patchFetch(hostnames, _this._instance.get_distinct_id(), _this._instance.sessionManager);
            }
        };
    }
    ...
    TracingHeaders.prototype._getConfiguredHostnames = function () {
        ...
        return (_a = this._instance.config.addTracingHeaders) !== null && _a !== void 0 ? _a : this._instance.config.__add_tracing_headers;
    };
