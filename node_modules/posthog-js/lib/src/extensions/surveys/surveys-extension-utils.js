...
exports.clearInProgressSurveyState = exports.isSurveyInProgress = exports.getInProgressSurveyState = exports.setInProgressSurveyState = exports.renderChildrenAsTextOrHtml = exports.useSurveyContext = exports.SurveyContext = exports.hasWaitPeriodPassed = exports.getSurveySeen = exports.canActivateRepeatedly = exports.hasEvents = exports.getDisplayOrderQuestions = exports.getDisplayOrderChoices = exports.shuffle = exports.sendSurveyAbandonedEvent = exports.dismissedSurveyEvent = exports.sendSurveyEvent = exports.retrieveSurveyShadow = exports.addSurveyCSSVariablesToElement = exports.defaultSurveyAppearance = exports.getSurveyResponseKey = void 0;
...
Object.defineProperty(exports, "getSurveyResponseKey", { enumerable: true, get: function () { return surveys_1.getSurveyResponseKey; } });
...
exports.defaultSurveyAppearance = {
    ...
    widgetColor: 'black',
    zIndex: String(constants_1.Z_INDEX_SURVEYS),
...
var BOTTOM_BORDER_SURVEY_POSITIONS = [
...
var addSurveyCSSVariablesToElement = function (element, type, appearance) {
    ...
    var surveyHasBottomBorder = !BOTTOM_BORDER_SURVEY_POSITIONS.includes(effectiveAppearance.position) ||
    ...
    hostStyle.setProperty('--ph-survey-text-primary-color', (appearance === null || appearance === void 0 ? void 0 : appearance.textColor) || getContrastingTextColor(effectiveAppearance.backgroundColor));
    ...
    var userInputBg = (appearance === null || appearance === void 0 ? void 0 : appearance.inputBackground) || (appearance === null || appearance === void 0 ? void 0 : appearance.inputBackgroundColor);
    var inputBgColor = userInputBg || effectiveAppearance.inputBackground;
    ...
    var inputTextColor = (appearance === null || appearance === void 0 ? void 0 : appearance.inputTextColor) || getContrastingTextColor(inputBgColor);
...
var sendSurveyEvent = function (_a) {
    var _b, _c, _d;
    var _e;
    var responses = _a.responses, survey = _a.survey, surveySubmissionId = _a.surveySubmissionId, posthog = _a.posthog, isSurveyCompleted = _a.isSurveyCompleted, properties = _a.properties, surveyLanguage = _a.surveyLanguage;
    if (!posthog) {
...
var _buildSurveyEventProperties = function (survey, inProgressSurvey, posthog) {
    var _a, _b, _c;
    var _d;
    return (__assign(__assign(__assign((_a = {}, _a[posthog_surveys_types_1.SurveyEventProperties.SURVEY_NAME] = survey.name, _a[posthog_surveys_types_1.SurveyEventProperties.SURVEY_ID] = survey.id, _a[posthog_surveys_types_1.SurveyEventProperties.SURVEY_ITERATION] = survey.current_iteration, _a[posthog_surveys_types_1.SurveyEventProperties.SURVEY_ITERATION_START_DATE] = survey.current_iteration_start_date, _a[posthog_surveys_types_1.SurveyEventProperties.SURVEY_PARTIALLY_COMPLETED] = (0, surveys_1.surveyHasResponses)(inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.responses), _a), ((inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.surveyLanguage) && (_b = {},
        _b[posthog_surveys_types_1.SurveyEventProperties.SURVEY_LANGUAGE] = inProgressSurvey.surveyLanguage,
        _b))), (_c = { sessionRecordingUrl: (_d = posthog.get_session_replay_url) === null || _d === void 0 ? void 0 : _d.call(posthog) }, _c[posthog_surveys_types_1.SurveyEventProperties.SURVEY_SUBMISSION_ID] = inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.surveySubmissionId, _c)), (0, surveys_1.buildSurveyResponseProperties)(inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.responses, survey)));
};
var dismissedSurveyEvent = function (survey, posthog, readOnly, surveyLanguage) {
    var _a, _b;
    if (!posthog) {
...
var sendSurveyAbandonedEvent = function (survey, posthog) {
    if (!posthog) {
        survey_utils_1.SURVEY_LOGGER.error('[survey abandoned] event not captured, PostHog instance not found.');
        return;
    }
    var abandonedKey = (0, survey_utils_1.getSurveyAbandonedKey)(survey);
    try {
...
exports.sendSurveyAbandonedEvent = sendSurveyAbandonedEvent;
...
var getSurveySeen = function (survey) {
    var surveySeen = storage_1.localStore._get((0, survey_utils_1.getSurveySeenKey)(survey));
    if (surveySeen) {
...
var hasWaitPeriodPassed = function (waitPeriodInDays) {
    var lastSeenSurveyDate = storage_1.localStore._get(LAST_SEEN_SURVEY_DATE_KEY);
    return (0, matcher_utils_1.hasPeriodPassed)(waitPeriodInDays, lastSeenSurveyDate);
};
