...
function OpenTextQuestion(_a) {
    ...
    var validationError = (0, hooks_1.useMemo)(function () {
        return (0, surveys_1.getValidationError)(text, question.validation, question.optional);
    }, [text, question.validation, question.optional]);
    // Build requirements hint message
    var minLength = (0, surveys_1.getLengthFromRules)(question.validation, core_1.SurveyValidationType.MinLength);
    var maxLength = (0, surveys_1.getLengthFromRules)(question.validation, core_1.SurveyValidationType.MaxLength);
    var requirementsHint = (0, hooks_1.useMemo)(function () { return (0, surveys_1.getRequirementsHint)(minLength, maxLength); }, [minLength, maxLength]);
