...
import { type SurveyResponses } from '@posthog/core';
...
export declare function hex2rgb(c: string): string;
export declare function hexToRgba(hex: string, opacity: number): string;
export declare function getContrastingTextColor(color?: string): "#020617" | "white";
...
export declare const sendSurveyEvent: ({ responses, survey, surveySubmissionId, posthog, isSurveyCompleted, properties, surveyLanguage, }: SendSurveyEventArgs) => void;
export declare const dismissedSurveyEvent: (survey: Survey, posthog?: PostHog, readOnly?: boolean, surveyLanguage?: string | null) => void;
export declare const sendSurveyAbandonedEvent: (survey: Survey, posthog?: PostHog) => void;
 ...
 */
export declare function getPopoverPosition(type?: SurveyType, position?: SurveyPosition, surveyWidgetType?: SurveyWidgetType): Record<string, string>;
