...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this.handlePopoverSurvey = function (surveyParam, options) {
            var _a, _b, _c, _d, _e;
            var _f = _this._translateSurveyForRendering(surveyParam), translatedSurvey = _f.survey, surveyLanguage = _f.language;
            ...
            var _g = options !== null && options !== void 0 ? options : {}, properties = _g.properties, initialResponses = _g.initialResponses;
            ...
            if (isSurveyCompleted && !((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.displayThankYouMessage)) {
                return;
            }
            _this._addSurveyToFocus(survey);
            // Calculate position style for NextToTrigger positioning
            var positionStyle = {};
            if (((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.position) === posthog_surveys_types_1.SurveyPosition.NextToTrigger && ((_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.widgetSelector)) {
                var targetElement = document.querySelector(survey.appearance.widgetSelector);
                if (targetElement) {
                    positionStyle =
                        getNextToTriggerPosition(targetElement, parseInt(((_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.maxWidth) || surveys_extension_utils_1.defaultSurveyAppearance.maxWidth)) || {};
                }
            }
            var delaySeconds = ((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.surveyPopupDelaySeconds) || 0;
            ...
            var timeoutId = setTimeout(function () {
                ...
                (0, preact_2.render)((0, jsx_runtime_1.jsx)(SurveyPopup, __assign({}, surveyPopupProps, { survey: __assign(__assign({}, survey), { appearance: __assign(__assign({}, survey.appearance), { surveyPopupDelaySeconds: 0 }) }) })), shadow);
            }, delaySeconds * 1000);
        ...
        this.renderSurvey = function (survey, selector, properties) {
            ...
            if ((_b = (_a = _this._posthog.config) === null || _a === void 0 ? void 0 : _a.surveys) === null || _b === void 0 ? void 0 : _b.prefillFromUrl) {
                isSurveyCompleted = _this._handleUrlPrefill(translatedSurvey, surveyLanguage);
            }
    ...
    SurveyManager.prototype._handleUrlPrefill = function (survey, surveyLanguage) {
...
function SurveyPopup(_a) {
    ...
    var surveyPopupDelayMilliseconds = ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds)
        ...
        : 0;
    var _p = usePopupVisibility(survey, posthog, surveyPopupDelayMilliseconds, isPreviewMode, removeSurveyFromFocus, isPopup, surveyContainerRef, skipShownEvent, surveyLanguage), isPopupVisible = _p.isPopupVisible, isSurveySent = _p.isSurveySent, hidePopupWithViewTransition = _p.hidePopupWithViewTransition;
    /**
