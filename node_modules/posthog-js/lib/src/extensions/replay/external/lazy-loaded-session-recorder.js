...
function buildCompressedMutationEvent(event, fields) {
    return __assign(__assign({}, event), { cv: '2024-10', data: __assign(__assign({}, event.data), fields) });
}
function buildCompressedStyleEvent(event, fields) {
    return __assign(__assign({}, event), { cv: '2024-10', data: __assign(__assign({}, event.data), fields) });
}
/**
...
function compressEventSync(event) {
    try {
        ...
        if (event.type === rrweb_types_1.EventType.IncrementalSnapshot && event.data.source === rrweb_types_1.IncrementalSource.Mutation) {
            return compressedResult(buildCompressedMutationEvent(event, {
        ...
        if (event.type === rrweb_types_1.EventType.IncrementalSnapshot && event.data.source === rrweb_types_1.IncrementalSource.StyleSheetRule) {
            return compressedResult(buildCompressedStyleEvent(event, {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, compressedResult(buildCompressedMutationEvent(event, { texts: texts, attributes: attributes, removes: removes, adds: adds }))];
                case 4:
                ...
                case 5:
                    ...
                    return [2 /*return*/, compressedResult(buildCompressedStyleEvent(event, { adds: adds, removes: removes }))];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!compressionEnabled) return [3 /*break*/, 4];
                        if (!shouldUseNativeAsyncSessionRecordingGzip(event)) return [3 /*break*/, 2];
                        return [4 /*yield*/, compressEventAsync(event)];
                    case 1:
                        _c = _d.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        _c = compressEventSync(event);
                        _d.label = 3;
                    case 3:
                        _b = _c;
                        return [3 /*break*/, 5];
                    case 4:
                        _b = { event: event, size: (0, sessionrecording_utils_1.estimateSize)(event) };
                        _d.label = 5;
                    case 5:
                        _a = _b, eventToSend = _a.event, size = _a.size;
                        this._captureQueuedCompressionEvent(queuedEvent, eventToSend, size);
                        return [3 /*break*/, 7];
                    case 6:
                        this._finishQueuedCompressionEvent(queuedEvent);
