...
var LazyLoadedDeadClicksAutocapture = /** @class */ (function () {
    function LazyLoadedDeadClicksAutocapture(instance, config) {
        ...
        this._onVisibilityChange = function () {
            if ((globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.visibilityState) === 'visible') {
                _this._lastVisibilityChange = Date.now();
            }
        };
    ...
    LazyLoadedDeadClicksAutocapture.prototype._startVisibilityChangeObserver = function () {
        (0, utils_1.addEventListener)(globals_1.document, 'visibilitychange', this._onVisibilityChange);
    };
    LazyLoadedDeadClicksAutocapture.prototype._ignoreClick = function (click) {
        ...
        if ((0, element_utils_1.isTag)(click.node, 'html') || !(0, element_utils_1.isElementNode)(click.node) || (0, autocapture_utils_1.shouldSkipDeadClick)(click.node)) {
            return true;
        }
        if (!(0, autocapture_utils_1.shouldCaptureDeadClick)(click.node, { css_selector_ignorelist: this._config.css_selector_ignorelist })) {
            return true;
        }
        return false;
    };
    LazyLoadedDeadClicksAutocapture.prototype._checkClicks = function () {
        ...
        try {
            for (var clicksToCheck_1 = __values(clicksToCheck), clicksToCheck_1_1 = clicksToCheck_1.next(); !clicksToCheck_1_1.done; clicksToCheck_1_1 = clicksToCheck_1.next()) {
                ...
                var visibilityChangedTimeout = checkTimeout(click.visibilityChangedDelayMs, this._config.selection_change_threshold_ms);
                if (scrollTimeout ||
                    mutationTimeout ||
                    absoluteTimeout ||
    ...
    LazyLoadedDeadClicksAutocapture.prototype._captureDeadClick = function (click, properties) {
        ...
        }).props), { $dead_click_scroll_delay_ms: click.scrollDelayMs, $dead_click_mutation_delay_ms: click.mutationDelayMs, $dead_click_absolute_delay_ms: click.absoluteDelayMs, $dead_click_selection_changed_delay_ms: click.selectionChangedDelayMs, $dead_click_visibility_changed_delay_ms: click.visibilityChangedDelayMs }), {
