...
var ConsentManager = /** @class */ (function () {
    ...
    Object.defineProperty(ConsentManager.prototype, "consent", {
        get: function () {
            if (this._getDnt()) {
                return exports.ConsentStatus.DENIED;
            }
    ...
    ConsentManager.prototype.isOptedOut = function () {
        ...
        return (this.isRejected() ||
            (this.consent === exports.ConsentStatus.PENDING && this._config.cookieless_mode === constants_1.COOKIELESS_ON_REJECT));
    };
    ConsentManager.prototype.isOptedIn = function () {
        return !this.isOptedOut();
    };
    ConsentManager.prototype.isExplicitlyOptedOut = function () {
        return this.consent === exports.ConsentStatus.DENIED;
    };
    ConsentManager.prototype.isRejected = function () {
        return (this.consent === exports.ConsentStatus.DENIED ||
            (this.consent === exports.ConsentStatus.PENDING && this._config.opt_out_capturing_by_default));
    };
    ...
    Object.defineProperty(ConsentManager.prototype, "_storedConsent", {
        get: function () {
            ...
            return (0, core_1.isYesLike)(value) ? exports.ConsentStatus.GRANTED : (0, core_1.isNoLike)(value) ? exports.ConsentStatus.DENIED : exports.ConsentStatus.PENDING;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ConsentManager.prototype, "_storage", {
        get: function () {
            ...
            var expectedStore = persistenceType === 'localStorage' ? storage_1.localStore : storage_1.cookieStore;
    ...
    ConsentManager.prototype._getDnt = function () {
        ...
        ].some(function (dntValue) { return (0, core_1.isYesLike)(dntValue); });
    };
