...
var PostHogProductTours = /** @class */ (function () {
    ...
    Object.defineProperty(PostHogProductTours.prototype, "_persistence", {
        get: function () {
    ...
    PostHogProductTours.prototype.initialize = function () {
        this.loadIfEnabled();
    };
    ...
    PostHogProductTours.prototype.getProductTours = function (callback, forceReload) {
        ...
        if (persistence) {
            var storedTours = persistence.props[constants_1.PRODUCT_TOURS];
        ...
        this._instance._send_request({
            ...
            callback: function (response) {
                ...
                if (persistence) {
                    persistence.register((_a = {}, _a[constants_1.PRODUCT_TOURS] = tours, _a));
                }
    ...
    PostHogProductTours.prototype.clearCache = function () {
        var _a;
        this._cachedTours = null;
        (_a = this._persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_1.PRODUCT_TOURS);
    };
